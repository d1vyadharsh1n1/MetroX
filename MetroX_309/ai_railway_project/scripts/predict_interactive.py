...
print("🚀 Interactive Script started - importing modules...")
...
def interactive_modification_system(initial_schedule, fleet_analytics):
    ...
    while True:
        ...
        if choice == '1':
            ...
            display_schedule(current_schedule, "CURRENT MODIFIED SCHEDULE")
            ...
            print("   [1] Force specific train to Service")
            print("   [2] Simulate train failure")
            print("   [3] Change maintenance schedule")
            print("   [4] Adjust service hours/headway")
            ...
            if scenario_choice == '1':
                ...
                if train_id in current_schedule['train_id'].values:
                    current_status = current_schedule.loc[current_schedule['train_id'] == train_id, 'final_status'].iloc[0]
                    risk = current_schedule.loc[current_schedule['train_id'] == train_id, 'predicted_failure_risk'].iloc[0]
                ...
                print("   ℹ️  Other scenarios not implemented in this demo")
...
def main():
    print("\n" + "="*50)
    print("🚀 METRO SCHEDULE OPTIMIZATION STARTED (INTERACTIVE MODE)")
    print("="*50)
    ...
    try:
        ...
        required_columns = ['train_id', 'dayid', 'date']
    ...
    if modification_log:
        display_schedule(final_schedule, "FINAL MODIFIED SCHEDULE")
    ...
    print("\n" + "="*50)
    print("✅ METRO SCHEDULE OPTIMIZATION COMPLETED (INTERACTIVE MODE)")
    print("="*50)
